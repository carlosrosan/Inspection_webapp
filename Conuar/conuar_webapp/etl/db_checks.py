...
tables_df.to_csv("C:/Inspection_webapp/Conuar/conuar_webapp/etl/tables_list.csv", index=False)
databases_df.to_csv("C:/Inspection_webapp/Conuar/conuar_webapp/etl/databases_list.csv", index=False)
